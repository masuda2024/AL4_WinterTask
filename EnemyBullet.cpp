...
// プレイヤーと敵の弾の衝突
void EnemyBullet::OnCollition3(const Player* player) { (void)player; }

#pragma endregion

#pragma region 敵の弾とプレイヤーの弾の当たり判定
...
// プレイヤーと敵の弾の衝突
void EnemyBullet::OnCollition4(const PlayerBullet* playerBullet) { (void)playerBullet; }
